...
object Test {
  ...
  def main(args: Array[String]) {
    ...
    val bedFilePath = "/Users/mariusz-macbook/IdeaProjects/zsi-bio-cnv/resources/data/probes.txt"
    val bamFilesPath = "/Users/mariusz-macbook/IdeaProjects/zsi-bio-cnv/resources/data"
